...
Route::get('posts/filter', [VisitorPostController::class, 'filter'])->name('posts.filter');
Route::get('posts/ajax-filter', [VisitorPostController::class, 'ajaxFilter'])->name('posts.ajaxFilter');
